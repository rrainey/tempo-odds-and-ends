...
int main(void)
{
	...
	printf("ICM42688 sensor application\n");
	...
	if (sensor_trigger_set(icm42688, &tap_trigger,
			       handle_icm42688_tap) < 0) {
	...
	if (sensor_trigger_set(icm42688, &data_trigger,
			       handle_icm42688_drdy) < 0) {
